            ...
            <div class="container">
                <div class="aonomy-contact-container">
                    <div class="row" id="form_prenda">
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                <input type="text" id="txt_buscar" placeholder="Buscar categoria por descripción" maxlength="20">
                            </div>
                        </div>
                        <div class="col-xl-1">
                            <div class="form-group">
                                <button type='button' class='btn btn-danger' onclick="recargar_categoria();">Buscar</button>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="form-group">
                                <a data-toggle="modal" data-target="#login_modal"><button type='button' class='btn btn-danger' onclick="nuevo_categoria();">Agregar categoria</button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="table-title"><i class="fas fa-table mr-1"></i>LISTADO DE CATEGORIAS</div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody id="contenido-clientes">
                                            <%@ include file="operaciones/categoria/tablaCategoria.jsp" %>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
