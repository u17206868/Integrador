...
<html>
    ...
    <body>
        <%
            File reportfile = new File(application.getRealPath("panel/operaciones/reportes/reporte-por-clientes.jasper"));
            Map<String, Object> parameter = new HashMap<String, Object>();
            int monto_min = Integer.parseInt(request.getParameter("monto_min"));
            int monto_max = Integer.parseInt(request.getParameter("monto_max"));
            String fecha1 = request.getParameter("fecha1");
            String fecha2 = request.getParameter("fecha2");
            parameter.put("monto_min", monto_min);
            parameter.put("monto_max", monto_max);
