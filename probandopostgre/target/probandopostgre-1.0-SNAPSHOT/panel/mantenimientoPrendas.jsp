...
<html>
    <head>
        ...
        <title>Mantenimiento de Prendas</title>
            ...
            <div class="container">
                <div class="aonomy-contact-container">
                    <div class="row" id="form_prenda">
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                <input type="text" id="txt_buscar" placeholder="Buscar prendas por Nombre" maxlength="20">
                            </div>
                        </div>
                        <div class="col-xl-1">
                            <div class="form-group">
                                <button type='button' class='btn btn-danger' onclick="recargar_prenda();">Buscar</button>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="form-group">
                                <a data-toggle="modal" data-target="#login_modal"><button type='button' class='btn btn-danger' onclick="nuevo_prenda();">Agregar Prenda</button></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" id="titleventana">
                        <h4 class="modal-title" id="myModalLabel">Modificar Prenda</h4>
                        ...
                        <div class="modal-body" style="text-align: center;">
                            <div class="aonomy-contact-container">
                                <div class="row" id="form-nuevocliente">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <center><button type="button" id="boton_login" onclick="registro_servicio_ajax()" class="btn btn-primary">Ingresar</button></center>
                                        </div>
                                    </div>
                    ...
                    <div id="layoutSidenav_content">
                        ...
                        <main>
                            <div class="container-fluid">
                                ...
                                <div class="card mb-4">
                                    <div class="table-title"><i class="fas fa-table mr-1"></i>LISTADO DE PRENDAS</div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody id="contenido-clientes">
                                                    <%@ include file="operaciones/prendas/tablaPrenda.jsp" %>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
