...
<html>
    <head>
        ...
        <title>Mantenimiento de Movilidades</title>
            ...
            <div class="container">
                <div class="aonomy-contact-container">
                    <div class="row" id="form_prenda">
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                <input type="text" id="txt_buscar" placeholder="Buscar movilidad por marca" maxlength="20">
                            </div>
                        </div>
                        <div class="col-xl-1">
                            <div class="form-group">
                                <button type='button' class='btn btn-danger' onclick="recargar_movilidad();">Buscar</button>
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="form-group">
                                <a data-toggle="modal" data-target="#login_modal"><button type='button' class='btn btn-danger' onclick="nuevo_movilidad();">Agregar movilidad</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="modal-body" style="text-align: center;">
                            <div class="aonomy-contact-container">
                                <div class="row" id="form-nuevocliente">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <center><button type="button" id="boton_login" onclick="registro_movilidad_ajax()" class="btn btn-primary">Ingresar</button></center>
                                        </div>
                                    </div>
                    ...
                    <div id="layoutSidenav_content">
                        ...
                        <main>
                            <div class="container-fluid">
                                ...
                                <div class="card mb-4">
                                    <div class="table-title"><i class="fas fa-table mr-1"></i>LISTADO DE MOVILIDADES</div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                <tbody id="contenido-clientes">
                                                    <%@ include file="operaciones/movilidad/tablaMovilidad.jsp" %>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
